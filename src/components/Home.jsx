		...
		<main>
			...
			<div className="grid-home-container">
				<section className="information-container rose-color">
					<img src="./home/launched.svg" alt="Launch" width="40px" height="auto" />
				...
				<section className="information-container green-color">
					...
					<img src="./home/collectorsEdition.svg" alt="Collector's Edition Preview" width="40px" height="auto" />
				</section>

				<section className="information-container green-color">
					<h3>Update 2.0 is coming soon...</h3>
					<p>Lots of New Features!</p>
					<img src="./home/update2.svg" alt="Update" width="40px" height="auto" />
				</section>

				<section className="information-container rose-color">
					<img src="./home/roadmap.svg" alt="Roadmap" width="40px" height="auto" />
